...
<main class="flex-1">
    <div>
        <!-- Hero Section -->
        <section class="relative h-80 bg-muted/30">
            ...
            <div class="relative container mx-auto h-full flex flex-col justify-center items-center text-center text-white">
                <h1 class="text-4xl md:text-5xl font-bold font-headline">À Propos de VylsCapital</h1>
