...
export const amlCertificateClauses: Clauses = {
    fr: {
        header: {
        ...
        articles: {
            ...
            commitment: {
                ...
                content: "Je m'engage à fournir à Neofonds, sur simple demande, tout document justificatif (bulletins de salaire, avis d'imposition, acte de vente, etc.) attestant de l'origine des fonds déclarée ci-dessus.",
            },
            warning: {
                title: "Article 3 : Avertissement sur les Fausses Déclarations",
                content: "Je reconnais avoir été informé(e) que toute fausse déclaration est passible de poursuites judiciaires et peut entraîner la résiliation immédiate de toute relation d'affaires avec Neofonds, ainsi qu'une déclaration de soupçon auprès des autorités compétentes (Tracfin en France, BaFin en Allemagne).",
            },
        },
        signature_label: "Signature du Déclarant",
    },
    en: {
        // English translations would follow a similar structure
    },
    de: {
        // German translations would follow a similar structure
    }
};
