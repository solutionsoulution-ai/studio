...
export const bankingLicenseClauses: Clauses = {
    fr: {
        ...
        status: "Il est accordé à l'entité Neofonds GmbH le statut d'Établissement de Crédit, l'autorisant à effectuer l'ensemble des opérations de banque sur le territoire de l'Union Européenne.",
    ...
    articles: {
        scope: {
            ...
            intro: "Dans le cadre de cet agrément, Neofonds est autorisée à réaliser, à titre de profession habituelle, les opérations de banque suivantes :",
        ...
        internal_control: {
            ...
            content: "Neofonds doit se doter d'un système de contrôle interne robuste et d'une gouvernance d'entreprise saine, incluant une séparation claire des fonctions, des procédures de gestion des risques efficaces, et un dispositif de conformité (compliance) assurant le respect des réglementations en vigueur."
        },
        lcbft: {
            title: "Article 5 : Lutte Contre le Blanchiment et le Financement du Terrorisme (LCB-FT)",
            content: "Neofonds doit appliquer des mesures de vigilance strictes pour la prévention du blanchiment de capitaux et du financement du terrorisme. Cela inclut l'identification et la vérification de l'identité de ses clients (KYC), le suivi de leurs opérations, et la déclaration de toute opération suspecte à l'autorité compétente (BaFin en Allemagne)."
        },
        customer_protection: {
        ...
        reporting: {
            ...
            content: "Neofonds est assujetti à des obligations de reporting périodique auprès de l'ACPR et de la Banque de France concernant sa situation financière, ses risques, et son respect des ratios réglementaires."
        }
    },
    en: {
