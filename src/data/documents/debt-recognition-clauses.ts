...
export const debtRecognitionClauses: Clauses = {
    ...
    en: {
        ...
        introduction: "I, the undersigned, {borrower_name}, residing at {borrower_address}, hereby acknowledge that I owe the sum described below to VylsCapital.",
    ...
    de: {
        ...
        introduction: "Ich, der/die Unterzeichnende, {borrower_name}, wohnhaft in {borrower_address}, erkenne hiermit an, VylsCapital die unten beschriebene Summe zu schulden.",
    ...
    es: {
        ...
        introduction: "Yo, el/la abajo firmante, {borrower_name}, con domicilio en {borrower_address}, por la presente reconozco adeudar la suma descrita a continuación a VylsCapital.",
    ...
    pt: {
        ...
        introduction: "Eu, o(a) abaixo-assinado(a), {borrower_name}, residente em {borrower_address}, pelo presente reconheço dever a quantia abaixo descrita à VylsCapital.",
        ...
        signature_preamble: "Feito em {signature_location}, em {signature_date}, em duas vias originais.",
    ...
    it: {
        ...
        introduction: "Io, il/la sottoscritto/a, {borrower_name}, residente in {borrower_address}, con la presente riconosco di dovere la somma sotto descritta a VylsCapital.",
        ...
        signature_preamble: "Fatto a {signature_location}, il {signature_date}, in due copie originali.",
