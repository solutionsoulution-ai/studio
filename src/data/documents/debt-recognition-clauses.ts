...
export const debtRecognitionClauses: Clauses = {
    ...
    de: {
        ...
        introduction: "Ich, der/die Unterzeichnende, {borrower_name}, wohnhaft in {borrower_address}, erkenne hiermit an, Capfinfy die unten beschriebene Summe zu schulden.",
    ...
    es: {
        ...
        introduction: "Yo, el/la abajo firmante, {borrower_name}, con domicilio en {borrower_address}, por la presente reconozco adeudar la suma descrita a continuación a Capfinfy.",
    ...
    pt: {
        ...
        introduction: "Eu, o(a) abaixo-assinado(a), {borrower_name}, residente em {borrower_address}, pelo presente reconheço dever a quantia abaixo descrita à Capfinfy.",
    ...
    it: {
        ...
        introduction: "Io, il/la sottoscritto/a, {borrower_name}, residente in {borrower_address}, con la presente riconosco di dovere la somma sotto descritta a Capfinfy.",
