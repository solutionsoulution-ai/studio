...
export const eligibilityCertificateClauses: Clauses = {
    ...
    en: {
        ...
        introduction: "We, the undersigned, Capfinfy, hereby certify that, based on the information provided and after an initial analysis of their file, the beneficiary: {beneficiary_name}, residing at {beneficiary_address} and identified by ID document No. {beneficiary_id_number}, has a profile that makes them eligible for a financing solution.",
    ...
    es: {
        ...
        introduction: "Nosotros, los abajo firmantes, Capfinfy, certificamos por la presente que, basándonos en la información proporcionada y tras un análisis inicial de su expediente, el beneficiario: {beneficiary_name}, con domicilio en {beneficiary_address} e identificado con el documento de identidad n.º {beneficiary_id_number}, presenta un perfil que le permite ser elegible para una solución de financiación.",
    ...
    pt: {
        ...
        introduction: "Nós, os abaixo assinados, Capfinfy, certificamos pelo presente que, com base nas informações fornecidas e após uma análise inicial do seu processo, o beneficiário: {beneficiary_name}, residente em {beneficiary_address} e identificado pelo documento de identidade n.º {beneficiary_id_number}, apresenta um perfil que o torna elegível para uma solução de financiamento.",
    ...
    it: {
        ...
        introduction: "Noi sottoscritti, Capfinfy, con la presente certifichiamo che, sulla base delle informazioni fornite e a seguito di un'analisi iniziale della sua pratica, il beneficiario: {beneficiary_name}, residente in {beneficiary_address} e identificato dal documento d'identità n.{beneficiary_id_number}, presenta un profilo che lo rende idoneo a una soluzione di finanziamento.",
