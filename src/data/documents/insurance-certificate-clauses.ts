...
export const insuranceCertificateClauses: Clauses = {
    fr: {
        ...
        department: "VylsCapital Assurance",
    ...
    en: {
        ...
        department: "VylsCapital Insurance",
        ...
        introduction: "VylsCapital Insurance hereby certifies that the insured person named below is covered by the group insurance contract No. 789-101112, subscribed by VylsCapital, for the loan described below.",
    ...
    de: {
        ...
        department: "VylsCapital Versicherung",
        ...
        introduction: "VylsCapital Versicherung bescheinigt hiermit, dass die unten genannte versicherte Person durch den von VylsCapital unterzeichneten Gruppenversicherungsvertrag Nr. 789-101112 für das unten beschriebene Darlehen gedeckt ist.",
    ...
    es: {
        ...
        department: "VylsCapital Seguros",
        ...
        introduction: "VylsCapital Seguros certifica por la presente que el asegurado abajo mencionado está cubierto por el contrato de seguro colectivo Nº 789-101112, suscrito por VylsCapital, para el préstamo que se describe a continuación.",
    ...
    pt: {
        ...
        introduction: "A VylsCapital Seguros certifica pelo presente que o segurado abaixo nomeado está coberto pelo contrato de seguro de grupo n.º 789-101112, subscrito pela VylsCapital, para o empréstimo descrito abaixo.",
    ...
    it: {
        ...
        department: "VylsCapital Assicurazioni",
        ...
        introduction: "VylsCapital Assicurazioni certifica con la presente che l'assicurato sotto indicato è coperto dal contratto di assicurazione collettiva n. 789-101112, sottoscritto da VylsCapital, per il prestito di seguito descritto.",
