...
const SuretyBondTemplate: React.FC<SuretyBondTemplateProps> = ({ formData, lang }) => {
    ...
    return (
        <div className="bg-white text-gray-800 font-serif p-8 max-w-4xl mx-auto border border-gray-300">
            <header className="flex justify-between items-start mb-12 border-b-2 border-gray-700 pb-4">
                ...
                <p className="text-xs text-gray-500">{replacePlaceholders(clauses.reference)}</p>
            </header>

            <main>
                <h2 className="text-3xl font-bold text-center text-blue-900 mb-10">{clauses.title}</h2>

                <div className="mb-8">
                    <h3 className="font-bold text-lg mb-2 border-b border-gray-200 pb-1">{clauses.parties.lender_label}</h3>
                    <p>Capfinfy, 1 Place de la Bourse, 69002 Lyon</p>
                </div>
                <div className="mb-8">
                    <h3 className="font-bold text-lg mb-2 border-b border-gray-200 pb-1">{clauses.parties.borrower_label}</h3>
                    <p>{formData.borrower_name || '___________'}</p>
                </div>
                <div className="mb-12">
                    <h3 className="font-bold text-lg mb-2 border-b border-gray-200 pb-1">{clauses.parties.guarantor_label}</h3>
                ...
                <div className="space-y-6 text-sm leading-relaxed">
                    ...
                    <div className="mt-8 p-4 border-l-4 border-blue-800 bg-blue-50">
                        <h4 className="font-bold text-md mb-2">{clauses.handwritten_mention.title}</h4>
                        <p className="text-xs italic mb-2">{clauses.handwritten_mention.instruction}</p>
                        <div className="border border-dashed border-gray-400 p-4 min-h-[100px] text-gray-600">
                ...
                <div className="grid grid-cols-2 gap-16 mt-16 pt-8">
                    <div className="text-center">
                        <div className="border-t border-gray-400 pt-2">
                             ...
                             <p className="text-xs text-gray-500 mt-2">{formData.guarantor_name || '___________'}</p>
                        </div>
                    </div>
                    <div className="text-center">
