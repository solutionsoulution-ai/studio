...
const VantexInvoiceTemplate: React.FC = () => {
    ...
    const vatRate = formData.vat_rate ? Number(formData.vat_rate) / 100 : 0.20; // Default VAT for France
            ...
            <section>
             ...
             <section className="mt-8 flex justify-end">
                <div className="w-full max-w-sm text-sm">
                    ...
                    <div className="flex justify-between py-2 mt-2 font-bold text-base bg-primary/10 px-2 rounded-md text-primary">
...
export default VantexInvoiceTemplate;
