...
export interface ItalianInvoiceData {
...
interface ItalianInvoiceTemplateProps {
    data: ItalianInvoiceData;
}

export default function ItalianInvoiceTemplate({ data }: ItalianInvoiceTemplateProps) {
    const clauses = invoiceClauses.it;
        ...
        <div id="pdf-preview" className="bg-white text-black text-sm font-serif shadow-2xl p-16 w-[210mm] min-h-[297mm] mx-auto relative">
            <header className="flex justify-between items-start mb-16">
                <div>
                    ...
                    <p className="text-gray-600 font-semibold">Ufficio Contabilità</p>
            ...
            <aside className="border-l-4 border-primary bg-primary/5 p-4 mb-10">
                <h3 className="font-bold text-primary flex items-center gap-2"><FileText size={18} /> Importanza di questo documento</h3>
                <p className="text-xs mt-2">
                    Una fattura è un documento contabile essenziale che certifica una transazione commerciale. Serve come prova del servizio fornito o della vendita, ed è indispensabile per la gestione contabile, la dichiarazione dell'IVA e come giustificativo in caso di controllo fiscale.
                </p>
            </aside>
                    ...
                    <div>
                     ...
                     <div className="text-center">
                        ...
                        <div className="border-t border-border pt-1">
                            ...
                            <p className="text-xs">Direttore Finanziario, VylsCapital</p>
                        </div>
                    </div>
                </div>
