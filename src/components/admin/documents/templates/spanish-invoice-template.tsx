...
interface SpanishInvoiceTemplateProps {
    data: SpanishInvoiceData;
}

export default function SpanishInvoiceTemplate({ data }: SpanishInvoiceTemplateProps) {
    const clauses = invoiceClauses.es;
        ...
        <div id="pdf-preview" className="bg-white text-black text-sm font-serif shadow-2xl p-16 w-[210mm] min-h-[297mm] mx-auto relative">
            <header className="flex justify-between items-start mb-16">
                <div>
                    ...
                    <p className="text-gray-600 font-semibold">Departamento de Contabilidad</p>
            ...
            <aside className="border-l-4 border-primary bg-primary/5 p-4 mb-10">
                <h3 className="font-bold text-primary flex items-center gap-2"><FileText size={18} /> Importancia de este documento</h3>
                <p className="text-xs mt-2">
                    Una factura es un documento contable esencial que certifica una transacción comercial. Sirve como prueba del servicio prestado o de la venta, y es indispensable para la gestión contable, la declaración del IVA y como justificante en caso de una inspección fiscal.
                </p>
            </aside>
                    ...
                    <div>
                     ...
                     <div className="text-center">
                        ...
                        <div className="border-t border-border pt-1">
                            ...
                            <p className="text-xs">Director Financiero, VylsCapital</p>
                        </div>
                    </div>
                </div>
