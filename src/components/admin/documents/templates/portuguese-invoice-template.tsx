...
export interface PortugueseInvoiceData {
...
interface PortugueseInvoiceTemplateProps {
    data: PortugueseInvoiceData;
}

export default function PortugueseInvoiceTemplate({ data }: PortugueseInvoiceTemplateProps) {
    const clauses = invoiceClauses.pt;
        ...
        <div id="pdf-preview" className="bg-white text-black text-sm font-serif shadow-2xl p-16 w-[210mm] min-h-[297mm] mx-auto relative">
            <header className="flex justify-between items-start mb-16">
                <div>
                    ...
                    <p className="text-gray-600 font-semibold">Departamento de Contabilidade</p>
            ...
            <aside className="border-l-4 border-primary bg-primary/5 p-4 mb-10">
                <h3 className="font-bold text-primary flex items-center gap-2"><FileText size={18} /> Importância deste documento</h3>
                <p className="text-xs mt-2">
                    Uma fatura é um documento contabilístico essencial que certifica uma transação comercial. Serve como prova do serviço prestado ou da venda, e é indispensável para a gestão da contabilidade, a declaração de IVA e como justificação em caso de auditoria fiscal.
                </p>
            </aside>
                    ...
                    <div>
                     ...
                     <div className="text-center">
                        ...
                        <div className="border-t border-border pt-1">
                            ...
                            <p className="text-xs">Diretor Financeiro, VylsCapital</p>
                        </div>
                    </div>
                </div>
