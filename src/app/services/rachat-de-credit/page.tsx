...
import { CheckCircle, FilePen, Search, HandCoins, Wallet, TrendingDown, Lightbulb, Recycle } from "lucide-react";
  ...
  return (
    <div className="flex flex-col min-h-dvh bg-background">
      ...
      <main className="flex-1">
        ...
        <section className="container mx-auto py-16 md:py-24">
            <FaqSection faqs={creditFaqs} title="Questions Fréquentes - Rachat de Crédit"/>
        </section>
