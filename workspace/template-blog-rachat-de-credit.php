<?php
/**
 * Template Name: Blog - Rachat de Crédit
 *
 * @package vyls
 */
...
<main class="flex-1">
    ...
    <section class="relative h-80 md:h-96">
        <div class="absolute inset-0">
            <img src="https://i.postimg.cc/kgn9jJ3Y/samuel-regan-asante-u-Rcbqai-Kk-Ko-unsplash.jpg" alt="Des factures et des cartes de crédit sont organisées en une seule pile ordonnée." class="object-cover w-full h-full">
        </div>
        ...
        <div class="relative container mx-auto h-full flex flex-col justify-center items-center text-center text-white px-4">
            <h1 class="text-3xl md:text-5xl font-bold font-headline max-w-4xl">Rachat de crédit : quand et pourquoi regrouper ses dettes ?</h1>
            <div class="mt-6 flex flex-col sm:flex-row items-center gap-4 sm:gap-6 text-sm">
                <div class="flex items-center gap-2">
                    ...
                    <span>15 Juil 2024</span>
                </div>
                <div class="flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                    <span>Par Isabelle Petit, Directrice des Assurances</span>
                </div>
            </div>
        </section>
            ...
            <aside class="lg:col-span-1 space-y-8 sticky top-24 h-fit">
                 <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
                    ...
                    <div class="p-6 pt-0 text-center">
                        <h4 class="font-semibold">Isabelle Petit</h4>
                         <p class="text-sm text-primary">Directrice des Assurances</p>
                    </div>
                </div>
