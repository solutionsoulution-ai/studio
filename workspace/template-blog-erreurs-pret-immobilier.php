...
<main class="flex-1">
    ...
    <section class="relative h-80 md:h-96">
        <div class="absolute inset-0">
            <img src="https://i.postimg.cc/kG03FCNs/hiveboxx-de-X-KChubo-Y-unsplash.jpg" alt="Un jeune couple regarde avec optimisme les plans de leur future maison." class="object-cover w-full h-full">
        </div>
        ...
        <div class="relative container mx-auto h-full flex flex-col justify-center items-center text-center text-white px-4">
            <h1 class="text-3xl md:text-5xl font-bold font-headline max-w-4xl">Prêt immobilier : les 7 erreurs à éviter pour un primo-accédant</h1>
            <div class="mt-6 flex flex-col sm:flex-row items-center gap-4 sm:gap-6 text-sm">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span>Par Alexandre Dubois, Directeur Général</span>
                </div>
            </div>
        </section>
    ...
    <section class="container mx-auto py-12 md:py-24 px-4">
        <div class="grid lg:grid-cols-4 gap-12">
            <article class="lg:col-span-3 prose-content lg:prose-lg max-w-none">
                <p>L'achat de votre première maison est une étape majeure. Évitez ces pièges courants pour une expérience sereine.</p>
                <h2>Introduction</h2>
                <p>
            ...
            <aside class="lg:col-span-1 space-y-8 sticky top-24 h-fit">
                 <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
                    ...
                    <div class="p-6 pt-0 text-center">
                        <h4 class="font-semibold">Alexandre Dubois</h4>
                         <p class="text-sm text-primary">Directeur Général</p>
                    </div>
                </div>
