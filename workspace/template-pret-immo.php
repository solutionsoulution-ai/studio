        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="w-full">
                ...
                <div data-state="closed" class="border-b">
                    ...
                    <div data-accordion-content style="display: none;" class="overflow-hidden text-sm transition-all"><div class="pb-4 pt-0 text-base text-muted-foreground">C'est de plus en plus rare, mais possible sous certaines conditions, notamment si vous avez un profil financier très solide (stabilité professionnelle, épargne existante, etc.). Chaque dossier est étudié au cas par cas.</div></div>
                </div>
                <div data-state="closed" class="border-b">
                    ...
                    <div data-accordion-content style="display: none;" class="overflow-hidden text-sm transition-all"><div class="pb-4 pt-0 text-base text-muted-foreground">La durée de remboursement peut aller jusqu'à 25 ans (300 mois), voire 30 ans (360 mois) dans de très rares cas. Une durée plus courte signifie des mensualités plus élevées mais un coût total du crédit plus faible.</div></div>
                </div>
            </div>
        </div>
    </section>
