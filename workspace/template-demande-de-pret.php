        ...
        <div class="mx-auto max-w-3xl">
           <div class="text-center mb-10">
            ...
            <div class="mt-12 rounded-lg border bg-card text-card-foreground shadow-sm p-6 md:p-8">
                ...
                <form class="space-y-6" action="/demande-de-pret/merci/" method="post">
                    ...
                    <div class="pt-4 space-y-4">
                        <div class="flex items-start space-x-3">
                            <input type="checkbox" id="terms" name="terms" required class="h-4 w-4 shrink-0 rounded-sm border border-primary ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 mt-1">
                    ...
                    <div class="text-xs text-muted-foreground flex items-center justify-center gap-2 pt-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-green-600"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="m9 12 2 2 4-4"/></svg>
                    ...
                    <p class="text-xs text-muted-foreground text-center">Un crédit vous engage et doit être remboursé. Vérifiez vos capacités de remboursement avant de vous engager.</p>
                </form>
            </div>
        </div>
    </div>
