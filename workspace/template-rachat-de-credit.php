    ...
    <section class="w-full py-16 md:py-24 bg-muted/30">
        <div class="container mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <div class="text-center border-transparent shadow-md hover:shadow-xl hover:border-primary transition-all rounded-lg border bg-card text-card-foreground"><div class="p-6"><div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 mb-4"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-8 w-8 text-primary"><path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9"/><path d="M3 10h18"/></svg></div><h3 class="text-2xl font-semibold leading-none tracking-tight">Simplifier votre budget</h3></div><div class="p-6 pt-0"><p class="text-sm text-muted-foreground">Ne gérez plus qu'un seul prélèvement и un seul interlocuteur. La gestion de vos finances personnelles devient plus claire et plus simple.</p></div></div>
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="w-full">
                <div data-state="closed" class="border-b">
                    <h3 class="flex flex-1 items-center justify-between py-4 font-medium text-lg">Quels types de crédits peuvent être rachetés ?</h3>
                    <div class="overflow-hidden text-sm"><div class="pb-4 pt-0 text-base text-muted-foreground">Nous pouvons regrouper la plupart de vos crédits à la consommation : prêts personnels, crédits renouvelables, prêts auto, etc. Les prêts immobiliers peuvent aussi être inclus dans l'opération sous certaines conditions.</div></div>
                </div>
                <div data-state="closed" class="border-b">
                    <h3 class="flex flex-1 items-center justify-between py-4 font-medium text-lg">Le rachat de crédit entraîne-t-il des frais ?</h3>
                    <div class="overflow-hidden text-sm"><div class="pb-4 pt-0 text-base text-muted-foreground">L'opération peut inclure des frais de dossier. De plus, le remboursement anticipé de vos anciens crédits peut engendrer des pénalités. Cependant, l'objectif est que le gain sur vos mensualités compense largement ces frais.</div></div>
                </div>
                <div data-state="closed" class="border-b">
                    <h3 class="flex flex-1 items-center justify-between py-4 font-medium text-lg">Est-ce que le rachat de crédit va vraiment améliorer mon taux d'endettement ?</h3>
                    <div class="overflow-hidden text-sm"><div class="pb-4 pt-0 text-base text-muted-foreground">Oui, c'est l'un des principaux objectifs. En allongeant la durée de remboursement et en négociant un taux unique, nous réduisons le montant total de vos mensualités, ce qui diminue mécaniquement votre taux d'endettement.</div></div>
                </div>
            </div>
        </div>
    </section>
