    ...
    <section class="w-full py-16 md:py-24 bg-muted/30">
        <div class="container mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <div class="text-center border-transparent shadow-md hover:shadow-xl hover:border-primary transition-all rounded-lg border bg-card text-card-foreground"><div class="p-6"><div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 mb-4"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#fe1c04" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 16c-1.2 1-2 2.5-2 4.5 0 2.8 2.2 5 5 5 2.5 0 4-1.2 5-3-1.2-1-2.5-2-4.5-2-2.8 0-5 2.2-5 5M10 5c-1.2-1-2.5-2-4.5-2-2.8 0-5 2.2-5 5 0 1.2 1 2.5 2 4.5C3.8 13.5 5 14.8 3 16c1-1.2 2-2.5 2-4.5S3.8 6.5 5 5.5c1.2-1 2.5-2 4.5-2 2.8 0 5 2.2 5 5"/><path d="M14 21c1.2-1 2.5-2 4.5-2 2.8 0 5-2.2 5-5s-2.2-5-5-5c-1.2 0-2.5 1-3.5 2-1 1-1.5 2.2-1.5 3.5 0 2.8 2.2 5 5 5Z"/></svg></div><h3 class="text-2xl font-semibold leading-none tracking-tight">Financer un nouveau projet</h3></div><div class="p-6 pt-0"><p class="text-sm text-muted-foreground">Profitez du regroupement pour inclure le financement d'un nouveau projet (voiture, travaux...) sans alourdir votre endettement.</p></div></div>
            </div>
        </div>
    </section>
