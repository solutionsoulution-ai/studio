...
<main class="flex-1">
    ...
    <section class="relative h-80 md:h-96">
        <div class="absolute inset-0">
            <img src="https://i.postimg.cc/Dz6hVtFf/walls-io-8mxs2-EDYGKQ-unsplash.jpg" alt="Une personne souriante planifie un projet sur une table de travail." class="object-cover w-full h-full">
        </div>
        ...
        <div class="relative container mx-auto h-full flex flex-col justify-center items-center text-center text-white px-4">
            <h1 class="text-3xl md:text-5xl font-bold font-headline max-w-4xl">Le prêt personnel : un outil flexible pour concrétiser vos projets</h1>
            <div class="mt-6 flex flex-col sm:flex-row items-center gap-4 sm:gap-6 text-sm">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span>Par David Rousseau, Directeur Juridique</span>
                </div>
            </div>
        </section>
            ...
            <aside class="lg:col-span-1 space-y-8 sticky top-24 h-fit">
                 <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
                    ...
                    <div class="p-6 pt-0 text-center">
                        <h4 class="font-semibold">David Rousseau</h4>
                         <p class="text-sm text-primary">Directeur Juridique</p>
                    </div>
                </div>
