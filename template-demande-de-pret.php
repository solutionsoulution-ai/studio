                ...
                <form class="space-y-8" action="/merci-demande" method="post">
                    <div class="rounded-lg border bg-card text-card-foreground shadow-sm p-6 space-y-6">
                        <div>
                            ...
                            <input type="text" name="nom_complet" placeholder="Jean Dupont" required class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base">
                        </div>
                        <div>
                            <label class="text-sm font-medium leading-none mb-2 block">Montant du Prêt (€)</label>
                            <input type="number" name="montant" placeholder="50000" required class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base">
                        </div>
                        <div>
                            <label class="text-sm font-medium leading-none mb-2 block">Durée de remboursement (mois)</label>
                            <input type="number" name="duree" placeholder="120" required class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="tel" name="telephone" placeholder="+33 6 12 34 56 78" required class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base">
                        </div>
                        <div>
                         ...
                         <div>
                            ...
                            <input type="text" name="profession" placeholder="Ex: Développeur" required class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base">
                        </div>
                        <div>
                            <label class="text-sm font-medium leading-none mb-2 block">Votre Revenu mensuel</label>
                            <input type="number" name="revenu" placeholder="3000" required class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base">
                        </div>
                        <div>
                            <label class="text-sm font-medium leading-none mb-2 block">Motif de la demande</label>
                            <textarea name="motif" rows="4" placeholder="Achat d'un véhicule, rénovation, etc." required class="flex min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-base"></textarea>
                        </div>
                    </div>
